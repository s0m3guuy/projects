...
<div class="layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav>
            ...
            <a href="penggajuanbunga.php"><i class="bi bi-file-earmark"></i><span>Pengajuan Bunga</span></a>
            <a href="pengajuanlunas.php"><i class="bi bi-file-earmark"></i><span>Pengajuan Lunas</span></a>
            ...
            <a href="user.php"><i class="bi bi-person"></i><span>User</span></a>
            <a href="laporan.php"><i class="bi bi-graph-up"></i><span>Laporan</span></a>
        </nav>
    </aside>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="tipe_pinjaman" name="tipe_pinjaman">
    ...
    if(memberId) {
        fetch('get_member_details.php?id=' + memberId)
            ...
            .then(data => {
                ...
                var loanCode = 'P' + year + month + day + random;
